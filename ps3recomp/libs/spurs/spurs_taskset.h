 ...
 * Pulled in from the real header rather than re-declared: ppu_memory.h defines
 * them `static inline`, and GCC rejects a static definition that follows a
 * non-static declaration (whichever header the TU happens to include first). */
