...
set(TAIKO_CHART_SOURCES
    ...
    src/taiko_osu_lazer.cpp src/taiko_nijiiro.cpp)
...
endforeach()
foreach(source src/taiko_chart_limits.h src/taiko_chart_internal.h tools/vendor/tja2fumen/hp_values.csv)
    set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/${source}")
    file(SHA256 "${CMAKE_CURRENT_SOURCE_DIR}/${source}" digest)
    string(APPEND TAIKO_CHART_RECIPE "${digest}")
endforeach()
...
target_include_directories(taiko_charts PRIVATE "${TAIKO_REALM_SOURCE}/src/external/json")
target_link_libraries(taiko_charts PRIVATE ZLIB::ZLIB)
if(WIN32)
